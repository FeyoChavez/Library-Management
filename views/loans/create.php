...
<head>
    ...
    <div class="col-md-5">
        <div class="card text-white bg-dark mb-3">
            <div class="card-header">Agregar Prestamos</div>
            <div class="card-body">
        ...
        <form method="post" action="" onsubmit="transformToUpperCase()">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="control_number" id="control_number" placeholder="No. de control:" required><br>
            </div>
